...
public class FullMassGemItem extends Item {
    public FullMassGemItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
        ...
        if(!entity.hasStatusEffect(increasedMassStatusEffectRegistry)){
            ...
            if(entity.hasStatusEffect(StatusEffects.LEVITATION))
            {
                ...
                entity.addStatusEffect(new StatusEffectInstance(increasedMassStatusEffectRegistry, Integer.MAX_VALUE, 0));
            }
        }
        else{
        ...
        var masGemStack = new ItemStack(EMPTY_MASS_GEM);
